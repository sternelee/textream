...
- [x] 时间轴预览：编辑器侧边 mini-map 显示节奏变化
- **Commit**: `feat: 脚本节奏 mini-map ScriptMiniMapView`
...
- [x] PracticeView 中支持框选句子循环播放
- [x] 句子级别评分（语速、停顿、发音）
- [x] 弱点句子自动标记到 "难点列表"
- **Commit**: `feat: 逐句循环练习 SentenceLoop`
...
| #   | 功能           | 新增文件                                                                    |
| --- | -------------- | --------------------------------------------------------------------------- |
| 1   | 富文本标记渲染 | `ScriptMarkupParser.swift`                                                  |
| 2   | 段落导航大纲   | `ScriptOutlineView.swift`                                                   |
| 3   | 节奏标记可视化 | `ScriptMiniMapView.swift`                                                   |
| 4   | 练习模式 MVP   | `PracticeSession.swift`, `PracticeService.swift`, `PracticeView.swift`      |
| 5   | 语速分析       | `WPMChartView.swift`                                                        |
| 6   | AI 润色        | `AIPolishView.swift`                                                        |
| 7   | 逐句循环练习   | `SentenceParser.swift`, `SentenceLoopView.swift`, `DifficultyTracker.swift` |
| 8   | 智能预警       | `SpeechRecognizer.swift` + `NotchOverlayController.swift`                   |
| 9   | 能力雷达图     | `RadarChartView.swift`, `PracticeHistoryView.swift`                         |
| 10  | Mock Q&A       | `MockQAView.swift`                                                          |

**总计**: 14 个新文件，10 个独立 commit
